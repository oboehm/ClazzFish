...
|https://app.travis-ci.com/github/oboehm/ClazzFish[Travis-CI.com]
|https://app.travis-ci.com/github/oboehm/ClazzFish/branches[image:https://app.travis-ci.com/oboehm/ClazzFish.svg?branch=master[Build Status]]
|https://app.travis-ci.com/github/oboehm/ClazzFish/branches[image:https://app.travis-ci.com/oboehm/ClazzFish.svg?branch=develop[Build Status]]
|s. link:../.travis.yml[.travis.yml]

|https://travis-ci.org/oboehm/ClazzFish/[Travis-CI.org] (old)
