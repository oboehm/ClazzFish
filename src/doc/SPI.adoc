...
As default the link:../../core/src/main/java/clazzfish/core/stat/ClazzStatistic.java[ClazzStatistic] exports the statistic to `ClazzStatistic.csv` in a temporary directory.
