...
- reduced memory footprint for module 'clazzfish-jdbc'
  ([issue #55](https://github.com/oboehm/ClazzFish/issues/55))

## [3.0.1] (16-Jan-2026)

### Fixed

- compact output for ConnectionMonitor at shutdown
  ([issue #50](https://github.com/oboehm/ClazzFish/issues/50))
